...
care_rexp  = /EAS09/
log_file   = "/data/slx/slxarchive_7/.incoming.queue/logs/EAS09.log"
# We'll save here the list of FCs that are done or are NEW
done_items =  StoreItems.new("/data/slx/slxarchive_7/.incoming.queue/logs/done_items.EAS09")
new_items  =  StoreItems.new("/data/slx/slxarchive_7/.incoming.queue/logs/new_items.EAS09")
lock       =  Locker.new("/data/slx/slxarchive_7/.incoming.queue/logs/lock.EAS09")
...
machine_dir= "/data/slx/USI-EAS09/Runs"
work_dir   = "/data/slx/slxarchivework_7"
