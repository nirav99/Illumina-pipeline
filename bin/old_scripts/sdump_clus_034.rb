...
care_rexp  = /EAS034/
log_file   = "/data/slx/slxarchive_7/.incoming.queue/logs/EAS034.log"
# We'll save here the list of FCs that are done or are NEW
done_items =  StoreItems.new("/data/slx/slxarchive_7/.incoming.queue/logs/done_items.EAS034")
new_items  =  StoreItems.new("/data/slx/slxarchive_7/.incoming.queue/logs/new_items.EAS034")
lock       =  Locker.new("/data/slx/slxarchive_7/.incoming.queue/logs/lock.EAS034")
# Origin/dst (origin is a remote machine we'll access via ssh, dst is local)
ssh_url    = "sol-pipe@172.30.18.12:/slxdump2/incoming"
origin     = Source.new(ssh_url, care_rexp, done_items)
dst        = "/data/slx/slxarchive_7"
machine_dir= "/data/slx/USI-EAS034/Runs"
work_dir   = "/data/slx/slxarchivework_9"
rsync      = Rsync.new(ssh_url, dst)

# CC to
Emailer.instance.ccs << 'dc12@bcm.edu'
Emailer.instance.ccs << 'niravs@bcm.edu'
Emailer.instance.ccs << 'yw14@bcm.edu'
